...
int	main(void)
{
	...
	mlx = mlx_init();
	mlx_win = mlx_new_window(mlx, 11500, 11600, "Hello world!");
	...
	my_mlx_pixel_put(&img, 11, 11, 0x00FF0000);
	my_mlx_pixel_put(&img, 12, 12, 0x00FF0000);
	my_mlx_pixel_put(&img, 13, 13, 0x00FF0000);
